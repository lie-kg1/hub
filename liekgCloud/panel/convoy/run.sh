...
while true; do
    ...
    case $OPTION in
        1)
            ...
            bash <(curl -s https://raw.githubusercontent.com/lie-kg1/hub/refs/heads/main/liekghub/panel/convoy/install.sh)
        ...
        4)
            ...
            bash <(curl -s https://raw.githubusercontent.com/lie-kg1/hub/refs/heads/main/liekghub/panel/convoy/uninstall.sh)
            read -p "Press Enter to return..."
            ;;
