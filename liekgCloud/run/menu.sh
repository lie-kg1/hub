...
# Change hostname to lie_kg before rendering
...
while true; do
    ...
    read -r opt
    case $opt in
        1) bash <(curl -s https://raw.githubusercontent.com/lie-kg1/hub/refs/heads/main/Codinghub/VM/menu.sh) ;;
        2) bash <(curl -s https://raw.githubusercontent.com/lie-kg1/hub/refs/heads/main/Codinghub/panel/run.sh) ;;
